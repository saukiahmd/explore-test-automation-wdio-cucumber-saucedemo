...
class LoginPage extends Page {
     ...
     */
    async verifyLogin () {
        await super.elementShouldDisplayed(this.inputUsername);
        await super.elementShouldDisplayed(this.inputPassword);
        await super.elementShouldDisplayed(this.btnSubmit);
    }
